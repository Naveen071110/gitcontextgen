...
import { Zap, ArrowRight, ShieldCheck, CheckCircle2, Lock } from 'lucide-react';
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md p-8 sm:p-10 rounded-2xl bg-slate-900/90 border border-slate-800 backdrop-blur-xl shadow-2xl space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-extrabold text-white tracking-tight">Sign In to GitContextGen</h1>
            <p className="text-xs text-slate-400">Manage repository context streams & automated AGENTS.md specs</p>
          </div>
          ...
          <div className="pt-4 border-t border-slate-800/80 space-y-2 text-xs font-mono text-slate-400">
            <div className="flex items-center gap-2">
              ...
              <span>Instant 1-Click Authentication (No Passwords)</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="w-3.5 h-3.5 text-cyan-400 shrink-0" />
              <span>Leverages your GitHub quota for unlimited audits</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="pt-2 text-center text-xs text-slate-500 font-mono">
            New to GitContextGen?{' '}
            <Link href="/auth/signup" className="text-cyan-400 hover:text-cyan-300 font-bold underline cursor-pointer">
              Create an Account
            </Link>
          </div>
        </div>
