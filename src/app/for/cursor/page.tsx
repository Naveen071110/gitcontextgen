...
export const metadata: Metadata = {
  ...
  keywords: [
    'GitContextGen for Cursor',
    'Cursor IDE rules generator',
    '.cursorrules setup for Cursor',
    'Cursor AI agent prompt context',
  ],
  openGraph: {
    title: 'GitContextGen for Cursor IDE | Auto-generate .cursorrules',
    description: 'Auto-generate evidence-backed .cursorrules files tuned specifically to your codebase.',
  ...
  alternates: {
    canonical: 'https://gitcontextgen.com/for/cursor',
  },
};
    ...
    <div className="min-h-screen bg-black text-white flex flex-col justify-between">
      ...
      <main className="w-full max-w-4xl mx-auto px-4 sm:px-6 pt-4 sm:pt-8 pb-20 flex flex-col items-center text-center">
        <div className="w-fit inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.04] text-xs font-mono text-cyan-400 mb-6">
          <ShieldCheck className="w-4 h-4" /> Optimized for Cursor IDE
        </div>
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
          Make Your Repo Ready for <span className="text-cyan-300 font-serif italic">Cursor AI.</span>
        </h1>
        <p className="text-white/60 text-base sm:text-lg max-w-2xl mb-10 leading-relaxed font-sans">
          Auto-generate evidence-backed <code className="text-white font-mono bg-white/10 px-2 py-0.5 rounded">.cursorrules</code> files tuned specifically to your repository structure and build rules.
        </p>
        <Link href="/" className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl bg-white text-black font-bold text-sm hover:opacity-90 shadow-2xl">
          Analyze Repo for Cursor <ArrowRight className="w-4 h-4" />
        </Link>
      </main>
      <Footer />
    </div>
