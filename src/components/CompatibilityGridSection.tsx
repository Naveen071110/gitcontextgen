...
export default function CompatibilityGridSection() {
  const agents = [
    {
      name: 'Claude Code (Sonnet 5, Opus 5 & Fable)',
      format: 'CLAUDE.md',
  ...
  return (
    <section id="compatibility" className="flex flex-col items-center justify-center w-full max-w-6xl mx-auto px-4 sm:px-6 py-28 md:py-36 bg-black text-white">
