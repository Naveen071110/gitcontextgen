...
export default function FaqSection() {
  ...
  const faqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer:
        'GitContextGen supports Next.js, React, Node.js, Python, Go, Rust, and more. It exports native specifications for Claude 3.7 Sonnet / Claude Code (CLAUDE.md), GitHub Copilot (.github/copilot-instructions.md), Cursor (.cursorrules), Replit (replit.md), Windsurf (windsurf.json), and AGENTS.md.',
